...
// 		alert(sdata[1] + " : mmid");
	...
	window.onload = function(){
		...
		for(var i = sMinute; i <= eMinute ; i += 30){
			if (i < 10){
				strMinute +="<option value = \'0" + i + "\'>"+ i + "분</option>"
			}else {
...
<body>
	...
	<div id="small-dialog1" class="mfp-hide">
		<form name="matchInsert" action="MatchInsert" method="post">
    ...
    background-color: rgb(255,255,255); color: black; font-weight: bolder;"
				...
				<div class="submit-w3l">
					<input type="button" id="yj" value="매치 생성" onClick="matchinsert()" /> <input
