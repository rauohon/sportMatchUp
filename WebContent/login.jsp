...
<style>
body {
	background-image: url(../images/banner1.jpg) no-repeat 0px 0px;
}
</style>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a class="w3_play_icon1" href="#small-dialog1">회원가입</a></li>
							<li><a href="login.jsp">로그인</a></li>
						</ul></li>


					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="login.jsp">매치보드 <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="login.jsp">커뮤니티 <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="login.jsp">경기장 <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a class="w3_play_icon1" href="#small-dialog1"><span
		...
		<div class="form-w3-agile">
			...
			<form action="Access" method="post">
				...
				<div class="form-sub-w3">
					<input type="text" name="mmid" placeholder="아이디 " required="" />
					<div class="icon-w3">
						<i class="fa fa-user" aria-hidden="true"></i>
					</div>
				</div>
				<div class="form-sub-w3">
					<input type="password" name="mmpw" placeholder="패스워드" required="" />
					<div>
						<font color="red">${message}</font> <font color="green">${email }</font>
						<!-- 멤버 업데이트. 실패시 -->
						<font color="green">${signup}</font>
						<!-- 회원가입 성공시  -->
					</div>
					<div class="icon-w3">
				...
				<p class="p-bottom-w3ls">
					Sport Match Now 에 처음이신가요 ?<a class="w3_play_icon1"
						href="#small-dialog2"> 회원가입 </a>
				</p>
				<p class="p-bottom-w3ls">
					비밀번호를 까먹으셨나요 ? <a class="w3_play_icon1" href="#small-dialog1">
						비밀번호 찾기 </a>
				</p>
		...
		<div class="contact-form1">
			<div class="contact-w3-agileits">
				...
				<form action="Join" name="join" method="post">
					...
					<div class="form-sub-w3ls">
						<input placeholder="Password" name="mmpw" type="password"
							required="">
						<div class="icon-agile">
							<i class="fa fa-unlock-alt" aria-hidden="true"></i>
						</div>
					...
					<div class="form-sub-w3ls">
						<input placeholder="Phonenumber" name="mmnumber" type="text"
							required="">
						<div class="icon-agile">
					...
					<div class="form-sub-w3ls">
						<input placeholder="Email" name="mmemail" class="mail"
							type="email" required="">
						<div class="icon-agile">
					...
					<div>
						<select name="lccode" required>
							...
							<option value="S0">서울:종로구,중구,용산구</option>
							<option value="I1">인천:서구,부평구,계양구</option>
							<option value="I2">인천:남구,중구</option>
							<option value="I3">인천:연수구,남동구</option>
							<option value="K1">경기:의정부시,양주시,포천시</option>
							<option value="K2">경기:구리시,남양주시</option>
							<option value="K3">경기:하남시,광주시</option>
							<option value="K4">경기:성남시,용인시</option>
							<option value="K5">경기:안양시,과천시,의왕시,안산시,군포시,수원시</option>
							<option value="K6">경기:부천시,김포시,광명시,시흥시</option>
							<option value="K7">경기:파주시,고양시</option>
						</select>
